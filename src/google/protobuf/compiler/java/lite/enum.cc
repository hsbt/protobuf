...
void EnumLiteGenerator::Generate(io::Printer* printer) {
  ...
  } else if (IsBitmaskEnum(descriptor_, &min_val, &mask)) {
    printer->Print(
        "public static com.google.protobuf.Internal.EnumVerifier \n"
        "    internalGetVerifier() {\n"
        "  return internalVerifier;\n"
        ...
        "private static final com.google.protobuf.Internal.EnumVerifier "
        "internalVerifier =\n"
        "    new com.google.protobuf.Internal.BitmaskEnumVerifier($min$, "
        "$mask$);\n"
        "\n",
        "min", absl::StrCat(min_val), "mask",
        absl::StrCat("0x", absl::Hex(mask, absl::kZeroPad16), "L"));
  } else {
    printer->Print(
        "public static com.google.protobuf.Internal.EnumVerifier \n"
        "    internalGetVerifier() {\n"
